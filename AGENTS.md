...
Use ASD-STE100 (Simplified Technical English) for all communication. Use the Google developer documentation style guide for points that ASD-STE100 does not cover.
